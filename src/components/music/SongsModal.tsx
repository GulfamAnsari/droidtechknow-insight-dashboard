  ...
  const loadMore = async () => {
    ...
    try {
      switch (songsModalData.type) {
        case 'artist':
          if (songsModalData.id) {
            newSongs = await musicApi.getArtistSongs(songsModalData.id, nextPage);
          }
          break;
        
        case 'search':
          if (songsModalData.query && songsModalData.searchType) {
            newSongs = await musicApi.searchByType(songsModalData.searchType, songsModalData.query, nextPage);
          }
          break;
      }
